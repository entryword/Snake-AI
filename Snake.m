...
%Generating GUI
    ...
    arenapopup=uicontrol('Parent',mainwindow,...
                         ...
                         'String',{'Infinite',...
                                   ...
                                   'Puzzle'},...
                         'Units','normalized',...
                         'Position',[0.48,0.2,0.17,0.025],...
                         'Callback',@selectarenapopupfcn);
    AIagent=uicontrol('Parent',mainwindow,...
             'Style','popup',...
             'String',{'DFS',...
                       'BFS',...
                       'uniform-cost'},...
             'Units','normalized',...
             'Position',[0.34,0.2,0.17,0.025],...
             'Callback',@selectAIagent);
...
%Start of AIagent
    function selectAIagent(~,~)
        AIindex=get(AIagent,'Value');
        field=generatefieldarray(deffield,snakepos,foodpos);
        drawfield(field)
        set(instructionbox,'String',['Agent was set to ',...
                                     num2str(AIindex)])
    end
